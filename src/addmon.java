...
public class addmon extends JFrame {
	 ...
	 * Create the frame.
	 */
	public addmon(String un,String passv) {
		setUndecorated(true);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(null,String.format("Rs %d is credited in your account.",dpa));
					amt.setText("");
		...
		btnAdd.setBounds(311, 384, 185, 55);
